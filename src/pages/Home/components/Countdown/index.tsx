...
export function Countdown() {
  ...
  const currentSeconds = activeCycle ? totalSeconds - amountSecondsPassed : 0;
    ...
    const minutesAmount = Math.floor(currentSeconds / 60); //floor= sempre arrdeonda o número para baixo
    const secondsAmount = currentSeconds % 60;
  
    //Garante que minutos e segundos sempre tenham duas casa, caso seja 9, vira 09
